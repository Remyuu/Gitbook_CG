...
![image-20230831145010708](https://regz-1258735137.cos.ap-guangzhou.myqcloud.com/remo\_t/image-20230831145010708.png)
...
![image-20230831145239967](https://regz-1258735137.cos.ap-guangzhou.myqcloud.com/remo\_t/image-20230831145239967.png)
...
![image-20230831145749059](https://regz-1258735137.cos.ap-guangzhou.myqcloud.com/remo\_t/image-20230831145749059.png)
...
![image-20230408155212728](https://regz-1258735137.cos.ap-guangzhou.myqcloud.com/remo\_t/MsPI1HRNmzxd6gS.png)
...
![image-20230905173407444](https://regz-1258735137.cos.ap-guangzhou.myqcloud.com/remo\_t/image-20230905173407444.png)
...
![image-20230906112817473](https://regz-1258735137.cos.ap-guangzhou.myqcloud.com/remo\_t/image-20230906112817473.png)
...
![image-20230907165837308](https://regz-1258735137.cos.ap-guangzhou.myqcloud.com/remo\_t/image-20230907165837308.png)
...
可以在这里[链接🔗](https://github.com/Remyuu/Tiny-Renderer/tree/Custom\_Math\_Lib)中获取当前的向量库代码。
...
添加了完整的注释供大家参考，可以在这个[链接🔗](https://github.com/Remyuu/Tiny-Renderer/tree/Custom\_Math\_Lib\_v2)中找到当前的数学库。
...
浏览我们目前的main函数，既有矩阵变换函数，也有视角变换函数，还有三角形重心坐标光栅化三角形的函数，更有视角变换矩阵等，真的有些乱。我们将这些方法打包到一个新的类里面，这个类称为：our\_gl。
...
![image-20230921171158181](https://regz-1258735137.cos.ap-guangzhou.myqcloud.com/remo\_t/image-20230921171158181.png)

其中，顶点着色和片元着色是可编程的。可以参考当前的项目代码[链接🔗](https://github.com/Remyuu/Tiny-Renderer/tree/6\_1\_Our\_GL)。
...
![image-20230921174128141](https://regz-1258735137.cos.ap-guangzhou.myqcloud.com/remo\_t/image-20230921174128141.png)
...
![image-20230921174422284](https://regz-1258735137.cos.ap-guangzhou.myqcloud.com/remo\_t/image-20230921174422284.png)
...
![image-20230921193615375](https://regz-1258735137.cos.ap-guangzhou.myqcloud.com/remo\_t/image-20230921193615375.png)
...
![image-20230921193810437](https://regz-1258735137.cos.ap-guangzhou.myqcloud.com/remo\_t/image-20230921193810437.png)
...
![image-20230921193918227](https://regz-1258735137.cos.ap-guangzhou.myqcloud.com/remo\_t/image-20230921193918227.png)
...
![image-20230921193958547](https://regz-1258735137.cos.ap-guangzhou.myqcloud.com/remo\_t/image-20230921193958547.png)

## 6.4 升级Shader-支持UV纹理

在上一节我们把玩了`GouraudShader`，现在我介绍一个更强的选手，`Shader`，他不仅能够处理光照，还支持纹理贴图！

![image-20230921212841026](https://regz-1258735137.cos.ap-guangzhou.myqcloud.com/remo\_t/image-20230921212841026.png)
...
1. **varying\_intensity**：这个角色没变，依然是顶点着色器计算出的光照强度。
2. **varying\_uv**：新角色登场！这家伙用来存储每个顶点的纹理坐标（u,v）。
...
![image-20230921214038676](https://regz-1258735137.cos.ap-guangzhou.myqcloud.com/remo\_t/image-20230921214038676.png)
...
![image-20230921222119442](https://regz-1258735137.cos.ap-guangzhou.myqcloud.com/remo\_t/image-20230921222119442.png)
...
![image-20230921222407082](https://regz-1258735137.cos.ap-guangzhou.myqcloud.com/remo\_t/image-20230921222407082.png)
...
Phong模型包含了三项**漫反射 (Diffuse Reflection)**、**镜面反射 (Specular Reflection)和环境反射 (Ambient Reflection)**。

![image-20230525172542652](https://regz-1258735137.cos.ap-guangzhou.myqcloud.com/remo\_t/agQhoxeqEs9IRpB.png) \$$ \begin{aligned} L & =L\_a+L\_d+L\_s \\\ & =k\_a I\_a+k\_d\left(I / r^2\right) \max (0, \mathbf{n} \cdot \mathbf{l})+k\_s\left(I / r^2\right) \max (0, \mathbf{n} \cdot \mathbf{h})^p \end{aligned} \$$ ![image-20230921234503261](https://regz-1258735137.cos.ap-guangzhou.myqcloud.com/remo\_t/image-20230921234503261.png)
...
![image-20230922113248506](https://regz-1258735137.cos.ap-guangzhou.myqcloud.com/remo\_t/image-20230922113248506.png) ![image-20230922113300470](https://regz-1258735137.cos.ap-guangzhou.myqcloud.com/remo\_t/image-20230922113300470.png)
...
![image-20230922163743152](https://regz-1258735137.cos.ap-guangzhou.myqcloud.com/remo\_t/image-20230922163743152.png)

奇怪的手臂阴影，这种现象我们称为阴影痤疮（Shadow Acne）。当渲染的物体与其阴影深度映射几乎重合时，可能会出现阴影斑点或噪声。

![image-20230922164007209](https://regz-1258735137.cos.ap-guangzhou.myqcloud.com/remo\_t/image-20230922164007209.png)
...
![image-20230922170825404](https://regz-1258735137.cos.ap-guangzhou.myqcloud.com/remo\_t/image-20230922170825404.png)

项目的代码可以还是继续提供给读者们解读，[链接🔗](https://github.com/Remyuu/Tiny-Renderer/tree/7\_1\_Shadow)。
...
项目完整代码，[链接🔗](https://github.com/Remyuu/Tiny-Renderer/tree/8\_1\_AO)。

![image-20230925172916074](https://regz-1258735137.cos.ap-guangzhou.myqcloud.com/remo\_t/image-20230925172916074.png)
